...
public class CliIntegrationTests
{
    ...
    public CliIntegrationTests()
    {
        ...
        _etPath = Path.Combine(
            ...
            "..", "..", "..", "..",
            "EasyTouch-Mac", "bin", "Release", "net10.0", "osx-x64", "publish", "et"
        );
    ...
    [Fact]
    public void Test_Spotlight_Search()
    {
        // macOS 特有的 Spotlight 搜索功能（如果实现）
        var (exitCode, output, error) = RunCommand("spotlight_search", "--query", "calculator");
